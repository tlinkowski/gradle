...
class DefaultMavenPublicationTest extends Specification {
    ...
    def createPublication() {
        ...
        def publication = new DefaultMavenPublication("pub-name", module, notationParser, instantiator, objectFactory, projectDependencyResolver, TestFiles.fileCollectionFactory(), featurePreviews, AttributeTestUtil.attributesFactory(), Mock(VersionMappingStrategyInternal))
        publication.setPomGenerator(createArtifactGenerator(pomFile))
